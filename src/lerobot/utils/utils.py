...
def log_say(text: str, play_sounds: bool = True, blocking: bool = False, color: str | None = None):
    ansi = {"green": "\033[32m", "red": "\033[31m"}
    reset = "\033[0m"
    prefix = ansi.get(color, "") if color else ""
    logging.info(f"{prefix}{text}{reset}" if prefix else text)
