...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        if sleep_time_s < 0 and start_loop_t - last_slow_loop_warning_t >= 10.0:
    ...
    try:
        ...
        with VideoEncodingManager(dataset):
            ...
            while recorded_episodes < cfg.dataset.num_episodes and not events["stop_recording"]:
                log_say(f"Recording episode {dataset.num_episodes}", cfg.play_sounds, color="green")
                record_loop(
                    robot=robot,
                    events=events,
                    fps=cfg.dataset.fps,
                ...
                if not events["stop_recording"] and (
                    ...
                    log_say("Reset the environment", cfg.play_sounds, color="red")
