...
def make_robot_from_config(config: RobotConfig) -> Robot:
    ...
    elif config.type == "openarmx_follower":
        from .openarmx_follower import OpenArmXFollower

        return OpenArmXFollower(config)
    elif config.type == "bi_openarm_follower":
        from .bi_openarm_follower import BiOpenArmFollower

        return BiOpenArmFollower(config)
    elif config.type == "bi_openarmx_follower":
        from .bi_openarmx_follower import BiOpenArmXFollower

        return BiOpenArmXFollower(config)
